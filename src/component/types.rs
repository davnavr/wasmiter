...
// TODO: maybe make allocator::SmallVec?

// struct FuncTypeInner<S: Vector<ValType>> {
//     Inline { arguments: u8, results: u8, types: [ValType; 7] }
//     Allocated { arguments: usize, types: S }
// }

/// Represents a
/// [WebAssembly function type](https://webassembly.github.io/spec/core/syntax/types.html#function-types),
/// which specifies the argument and return types of a function.
pub struct FuncType {
    // inner: FuncTypeInner
}
