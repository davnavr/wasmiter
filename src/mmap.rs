...
fn parse_module_sections_inner(path: &Path) -> parser::Result<SectionSequence<Mmap>> {
...
#[inline]
pub fn parse_module_sections<P: AsRef<Path>>(path: P) -> parser::Result<SectionSequence<Mmap>> {
